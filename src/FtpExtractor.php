...
class FtpExtractor
{
    ...
    private function getPotentialFiles(string $sourcePath): array
    {
        ...
        try {
            if (Glob::getStaticPrefix($absSourcePath) === $absSourcePath) { //means is file
                ...
                $items[] = [
                    'path' => $this->pathNormalizer->normalizePath($absSourcePath),
                ...
                $basePath = $this->pathNormalizer->normalizePath(Glob::getBasePath($absSourcePath));
    ...
    private function downloadFile(array $file): void
    {
        ...
        try {
            ...
            throw ExceptionConverter::handleDownloadException($e);
        }
